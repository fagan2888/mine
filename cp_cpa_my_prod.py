...
if __name__ == '__main__':
    ...
    signals = ['drec']
    # signals = [ 'd12p_tsv_in', 'e12p_tsv_in',  's12ev_tsv_in']
    ...
    for i in range(num_sigs):
        ...
        for _d in _dates:
            ...
            src_prod = root_prod + _y + '/' + _m + '/' + ymd + '/alphas_prod_consensus/' + s + '/' + _fn_after
            shutil.copyfile(src_prod, target_dir_before + _fn_after)
